...
<html>
 ...
 <p>
	 ...
	 in error, please file a bugreport <a href="https://trac.nbic.nl/gscf/newticket?summary=templateEditor%20invalid%20request&version=${meta(name: 'app.version')}" target="_new">here</a> with as much details as possible.
 </p>
